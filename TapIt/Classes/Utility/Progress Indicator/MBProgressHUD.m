...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.labelFont = [UIFont fontWithName:FONT_77_BOLD_CONDENSED size:kLabelFontSize];
		self.detailsLabelFont = [UIFont fontWithName:FONT_55_ROMAN size:kDetailsLabelFontSize];
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
