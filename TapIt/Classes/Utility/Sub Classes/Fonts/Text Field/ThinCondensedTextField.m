...
#import "ThinCondensedTextField.h"
#import "Constants.h"

@implementation ThinCondensedTextField
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self setFont: [UIFont fontWithName:FONT_37_THIN_CONDENSED size:self.font.pointSize]];
