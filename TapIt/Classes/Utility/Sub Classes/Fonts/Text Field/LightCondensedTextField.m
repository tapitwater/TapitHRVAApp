...
#import "LightCondensedTextField.h"
#import "Constants.h"

@implementation LightCondensedTextField
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self setFont: [UIFont fontWithName:FONT_47_LIGHT_CONDENSED size:self.font.pointSize]];
